...
type Action =
  ...
  | { type: 'UPDATE_WORKSPACE'; payload: {workspaceId:string, workspace: Partial<appWorkspacesType>} }
  ...
  | { type: 'UPDATE_FILE'; payload: {workspaceId:string; file: Partial<File>; folderId: string; fileId: string;} }
